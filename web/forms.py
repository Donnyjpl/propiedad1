...
class UsuarioUpdateForm(forms.ModelForm):
    ...
    class Meta:
        model = Usuario
        fields = ['first_name', 'last_name', 'rut', 'email', 'telefono_personal', 'tipo_usuario', 'region', 'comuna', 'direccion_calle', 'direccion_numero', 'direccion_punto_referencia']
        labels = {
            'first_name': 'Nombre',
            'last_name': 'Apellido',
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance and hasattr(self.instance, 'direccion') and self.instance.direccion:
            ...
            # Agregar atributo personalizado al widget de 'comuna'
            self.fields['comuna'].widget.attrs['data-selected'] = direccion.comuna.id
        else:
